    ...
    return (
        <div className='relative'>
            ...
            <div className="bg-white absolute rounded-s-3xl rounded-e-3xl top-4 w-full min-h-screen overflow-hidden">
                ...
                <div className="w-1/4 h-2 bg-gradient-to-r from-[#7CC140] to-[#388FCB] rounded-e-full mt-12"></div>
                <div className="w-[35%] h-2 bg-gradient-to-r from-[#388FCB] to-[#7CC140] rounded-e-full mt-2"></div>
                ...
                <div className='flex flex-col items-center sm:mt-32 mt-5 relative'>
                    <img src={secondLastImage} alt="Image" className='w-36 absolute' />
                    <div className='flex gap-x-2 text-3xl ml-28 mt-4 font-bold'>
                        <div className='text-white z-10 ml-1'>Mobile</div>
